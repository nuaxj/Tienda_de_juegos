...
<?php
	...
	if($_SESSION['tipoUsuario']==1) {
		...
		$consulta="SELECT * FROM pedidos,usuarios where pedidos.id_usuario=usuarios.id_usuario and pedidos.id_pedido=$id_pedido";
		...
		while ($fila=mysql_fetch_assoc($resultado_consulta)) {
			...
			echo "<td> <a href='detalle_ventas_pedido.php?id_pedido=$id_pedido&username=$username'>detalle</td>";
